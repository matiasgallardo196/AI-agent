...
export class CartsController {
  ...
  @Get(':id')
  async getCartById(@Param('id') cartId: number) {
    return this.cartsService.findById(Number(cartId));
  }

  @Get(':id/items')
  async getItemsWithProductInfo(@Param('id') cartId: number) {
    return this.cartsService.getItemsWithProductInfo(Number(cartId));
  }
}
